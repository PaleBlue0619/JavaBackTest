...
public class FutureOpenOrder extends FutureOrder {
    private final static String ORDER_STATE = "open";  // 订单状态(open/close)
    public String order_type;   // 订单类型(long/short)
//    public Double margin_rate;  // 保证金率 // 这里已经移动到Position类中, 在executeFutureOrder的时候才会被添加, 否则如果用户下单过多而成交甚少的话性能会亏太多!
    ...
    public FutureOpenOrder(String order_type, String symbol, Double vol, Double price, // Double margin_rate,
